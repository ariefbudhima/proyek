            ...
            <nav id="sidebar">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <!-- Side Navigation -->
                        <?php $this->load->view('laman/comp/menumedic');?>
...
<!--             <main id="main-container">-->
    ...
    <div class="content">
        ...
        <div class="block block-fx-shadow px-4 py-4" style="min-width: fit-content;">
            <!-- <div class="container-fluid"> -->
        <div class="row">
            <div class="body col-sm-6">
                <div class="col-sm-8">
                    <h4>DATA RIWAYAT KELUARGA</h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <?php $this->load->view('laman/tabel/tbl_riwayatkel');?>
            </div>
        </div>
